  ...
  return (
    <PublicLayout activeRoute="/about" onNavigate={onNavigate}>
      <div style={{ maxWidth: '800px', margin: '40px auto', padding: '0 16px' }} className="flex-col gap-md">
        <h1 className="page-heading">About Awaaz Man Ki</h1>
        <div className="mka-card flex-col gap-md">
          <p className="body-text">
            Awaaz Man Ki is an 18+ anonymous, text-first social platform designed to create a safe, respectful space for self-expression without public social pressure.
          </p>
